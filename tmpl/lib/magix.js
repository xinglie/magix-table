...
loader:cmd
enables:seajs
optionals:router,routerHash,routerState,routerTip,routerTipLockUrl,rich,richView,richVframe,mixins,recast,xml,customTags,service,state,mxevent
*/
//#snippet;
//#exclude = all;
 ...
 */
    ...
    let Updater_Digest = view => {
        let keys = view['j'], changed = view['k'], viewId = view.id, vf = Vframe_Vframes[viewId], ref = { 'a': [] }, tmpl, vdom, data = view['e'], refData = view['a'];
        view['k'] = 0;
        view['j'] = {};
